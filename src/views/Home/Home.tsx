                        ...
                        <div className={styles.content}>
                            <div className={styles.cardText}>
                                ...
                                <p>
                                    ...
                                    offers intuitive features that simplify the process of making motions, conducting votes, and managing discussions. Say goodbye to confusion and hello to clarity as
                                    your team engages in meaningful dialogue and reaches consensus with confidence.
                                </p>
                            </div>
