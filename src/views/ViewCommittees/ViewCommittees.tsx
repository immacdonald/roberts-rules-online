            ...
            {createModal && (
                <Modal>
                    ...
                    <form id="createCommittee" onSubmit={handleCreateCommittee}>
                        ...
                        <fieldset>
                            <label htmlFor="committeeDesc">Committee Description</label>
                            <Textbox
                                autoResize
                                type="text"
                                id="committeeDesc"
                                required={true}
                                onChange={(event: ChangeEvent<HTMLTextAreaElement>) => setCommitteeDesc(event.target.value)}
                                value={committeeDesc}
                            />
                        </fieldset>
                        <Modal.Actions>
