...
const PrivacyPolicy: FC = () => {
                    ...
                    <strong>
                        <span style="font-size: 15px;">
                            <span data-custom-class="subtitle">
                                Last updated 
                                <bdt class="question">December 03, 2024</bdt>
                            </span>
                        </span>
                    </strong>
                </span>
                        ...
                        <span style="font-size: 15px; color: rgb(89, 89, 89);">
                            <span data-custom-class="body_text">
                                ...
                                <span style="color: rgb(0, 58, 250);">
                                    <bdt class="question"><a href="https://roberts-rules-online.onrender.com" target="_blank" data-custom-class="link">https://roberts-rules-online.onrender.com</a></bdt>
                                </span>
                                <span style="font-size: 15px;">
                                    <span style="color: rgb(89, 89, 89);">
                                        <span data-custom-class="body_text">
    ...
    return (
        <Page>
            <Helmet>
                <title>Privacy Policy - Robert's Rules</title>
            </Helmet>
